...
//借用上展的json转换器，这是对cityData数据做的处理。
;(function(){
    var data = [],data2 = [];
...
//	年份
var year = [{"name":'2018',"value":'2018'},{"name":'2017',"value":'2017'},{"name":'2016',"value":'2016'}];
// 省份  为了省事我是用上面的cityData.
// 高校 
var universities = [{"name":'清华大学','value':'1'},{"name":'北京大学','value':'2'},{"name":'上海交通大学','value':'3'},{"name":'东北大学','value':'4'}];
//录取
//奖项
...
/**
        ...
        var method2=$('.select-value2').mPicker({
            ...
            rows:10,
            Linkage:false,
            header:'<div class="mPicker-header">高校</div>',
            idDefault:true,
            confirm:function(){
        ...
        var method3=$('.select-value3').mPicker({
            ...
            rows:10,
            idDefault:true,
            header:'<div class="mPicker-header">年份</div>',
            confirm:function(){
